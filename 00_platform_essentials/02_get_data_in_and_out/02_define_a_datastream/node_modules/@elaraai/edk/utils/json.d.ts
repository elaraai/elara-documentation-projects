...
export declare const replacer: (_key: any, value: any) => any;
export declare const reviver: (_key: any, value: any) => any;
export declare const revive: (value: any) => any;
export declare const pretty_replacer: (_key: any, value: any) => any;
