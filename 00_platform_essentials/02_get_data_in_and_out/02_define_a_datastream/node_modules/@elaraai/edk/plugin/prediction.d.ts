...
/**
 * Utility plugin to simplify creating diagnostic performance metrics for prediction.
 *
 * @return a {@link ELARASchema} containing the {@link PredictionPlugin}
 *
 * @category System
 *
 * @example
 * ```typescript
 * // Create diagnostic performance metrics for prediction.
 * const plugin = PredictionPlugin()
 * ```
 */
export declare function PredictionPlugin(): ELARASchema;
