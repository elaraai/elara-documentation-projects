import { Add, ArrayType, BooleanType, Const, FilterMap, IfElse, IntegerType, MapOption, Match, none, None, OptionType, PipelineBuilder, Some, some, SourceBuilder, StringType, Template, Unwrap, Variant, VariantType } from "@elaraai/core"
